...
void VulkanDevice::recordCommandBuffer(VulkanSwapchain& swapChain, VulkanRenderSequence& renderSequence, Object& object)
{
    VkViewport viewport{};
    viewport.x = 0.0f;
    viewport.y = 0.0f;
    ...
    commandBuffers.resize(renderSequence.getFramebufferSize());
